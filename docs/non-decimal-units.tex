...
\begin{docCommand}
	...
	It is possible to create configure commonly used symbols using the form \texttt{\meta{name}=\meta{symbol}}. These will be used as fallbacks if no specific symbol is configured via \refKey{segment:symbol}.

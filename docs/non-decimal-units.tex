...
\nduNormalize{danish rigsdaler}
	[treat zero as nil]{100}{skilling} % = 1.0.4
\end{dispExample*}
...
\begin{docCommand}
	...
	It is possible to create shortcut macros for commonly used unit groups with optional overriding options. These macros take the same arguments as the full \refCom{nduValue} macro, except without the first argument (ie. no need for the unit group).

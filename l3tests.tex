...
%units:~
%\seq_map_inline:Nn { \l_ndu_units_seq } {
%	[#1] 
%}
%\par
...
%	\int_show:c { l_ndu_factor_#1_#2_int } % DEBUG
}
...
%	\tl_show:c { l_ndu_symbol_#2_tl } % DEBUG
}
...
%factor-mark-skilling-int: ( \int_use:c { l_ndu_factor_mark_hvid_int } ) \par
%
%
%
%\cs_new_protected:Npn \ndu_factor_div:nnn #1#2#3
%{
%	\int_div_truncate:nn {#3} { \int_use:c { l_ndu_factor_#1_#2_int } }
%}
%\cs_new_protected:Npn \ndu_factor_mod:nnn #1#2#3
%{
%	\int_mod:nn {#3} { \int_use:c { l_ndu_factor_#1_#2_int } }
%}
%
%
%
...
%
%div-test~FOO: ( \ndu_factor_div:nnn \l_ndu_amount_int {skilling} { \seq_item:Nn \l_ndu_units_seq {2} } ) \par
...
%		\int_show:c { l_ndu_factor_##2_#2_int } % DEBUG
		\tl_if_blank:VF \__l_ndu_tmpa_tl {
%			\tl_show:N \__l_ndu_tmpa_tl % DEBUG
...
%amounts: (
%	\ndu_repr_to_seq:nnnnn \l_ndu_units_seq \l_ndu_base_unit_tl {100} {skilling} \l_result_seq
...
%
%formatted ~ amounts: (
%	\ndu_format_value:nnnn \l_ndu_units_seq \l_result_seq { ~ } \l_ndu_result_tl
%	\tl_use:N \l_ndu_result_tl
%) \par
